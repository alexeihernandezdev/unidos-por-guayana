...
/**
 * Combina las metas de una Ayuda (feature 005) con la agregación de aportes
 ...
 */
export async function progresoDeAyuda(
  ...
  const agregados = await aportes.progresoPorAyuda(ayudaId);
