...
import type { ShellNavSection } from "./navConfig";
...
export function MobileAppSidebar({ inicioHref, sections, slotSesion }: Props) {
  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent side="left" className="w-72 max-w-[80vw] p-0">
        <SheetTitle className="sr-only">Panel de funcionalidades</SheetTitle>
