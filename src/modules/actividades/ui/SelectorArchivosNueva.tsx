...
// Panel de la pantalla de creación de actividad: RECOLECTA la imagen principal y los
// documentos con previsualización local (blob), pero NO los sube. La subida real ocurre
// tras crear la actividad, cuando ya hay `id` (la orquesta `NuevaActividadCliente`).
// Reusa las mismas reglas y el mismo lenguaje visual que la 031 (feature 033).
  ...
  return (
    <fieldset className="flex flex-col gap-6 rounded-xl border border-border bg-muted/20 p-5">
      ...
      <p className="text-xs text-muted-foreground">
        Los archivos se subirán al crear la actividad.
      </p>
