...
16. **020 · Panel de usuario y redirección post-login** — Tras login cada rol aterriza en su panel (`/ayudas`, `/solicitudes`, `/panel`, `/cuenta-admin`, `/superadmin/admins`). Sidebar y botón Atrás en todas las áreas operativas; la landing deja de mostrarse con sesión activa. Módulo `src/modules/shell`.
