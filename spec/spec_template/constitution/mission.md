...
- **Administrador** — Persona u organización que gestiona las ayudas y decide cuándo sale el próximo envío y con qué recursos. **Cualquiera puede registrarse como administrador**, pero opera solo tras ser aprobado por un superadministrador. Cada administrador funciona además como **centro de acopio** y aporta datos ampliados: estado del país al que pertenece, municipio, nombre de la cuenta, teléfono, correo y documento de identidad (jurídico o natural). El estado y el municipio se eligen de un **catálogo cerrado** de la división político-territorial de Venezuela (no se escriben a mano).
